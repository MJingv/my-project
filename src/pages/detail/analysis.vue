<template>
      ...
      <div class="sales-board-form">
          ...
          <div class="sales-board-line">
              <div class="sales-board-line-left">
                ...
                <div class="sales-board-line-right">
                    <v-selection :selections="buyTypes" @on-change="onParamChange('buyType', $event)">
                    </v-selection>
                </div>
          </div>
          <div class="sales-board-line">
  ...
  @on-close-check-dialog="hideCheckDialog">
  </check-order>
...
export default {
  components:{
    VSelection,VChooser,VCounter,OrderList,
    VMulChooser,BankChooser,CheckOrder,
    MyDialog: Dialog
  },
   methods: {
